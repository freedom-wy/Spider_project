...
from utils.get_cookies import get_cookies_and_key
...
class GetCloud(object):
    ...
    def get_cookie(self):
        ...
        """
        # 渠道cookie和手机号
        cookies, key = get_cookies_and_key()
    ...
    def get_token(self, res):
        ...
        data = result.call('get_token', res)
        info = re.findall(
...
class SendEquityPenetration(object):
    ...
    def __init__(self, key, company_id, cloud_token, cloud_utm, cookie, session):
        ...
        self.headers1 = {
            ...
            'Origin': 'https://dis.tianyancha.com',
            'User-Agent': random.choice(my_headers),  # 随机ua池的ua
